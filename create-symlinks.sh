...
for dir in alacritty atuin clangd clash autostart dunst fish fontconfig fuzzel ghostty gtk-2.0 gtk-3.0 gtk-4.0 i3 i3status kanshi keynav kitty lazygit niri nvim nvimpager openmux paru polybar rofi tmux warpd waybar wezterm wl-kbptr xdg-desktop-portal yazi zellij picom.conf screenkey.json user-dirs.dirs user-dirs.locale; do
